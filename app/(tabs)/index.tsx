  ...
  return (
    ...
    >
          ...
          <ThemedView style={[styles.statusCard, styles.premiumCard]}>
            ...
            {activeEntitlements.length > 0 && (
              <ThemedView style={styles.entitlementsContainer}>
                <ThemedText style={styles.entitlementsTitle}>Active Entitlements:</ThemedText>
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          This RevenueCat framework is ready to use! Follow these steps to get started:
        </ThemedText>
      </ThemedView>
      
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="defaultSemiBold">Step 1: Configure API Keys</ThemedText>
        <ThemedText>
          Update <ThemedText type="defaultSemiBold">constants/RevenueCat.ts</ThemedText>{' '}
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          Create products and entitlements in the RevenueCat dashboard. Check the{' '}
          <ThemedText type="defaultSemiBold">RevenueCat Guide</ThemedText> tab for detailed instructions.
        </ThemedText>
      </ThemedView>
      
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="defaultSemiBold">Step 3: Test Your Integration</ThemedText>
        <ThemedText>
          Use sandbox accounts for testing. The{' '}
          <ThemedText type="defaultSemiBold">Profile</ThemedText> tab shows detailed customer info for debugging.
        </ThemedText>
      </ThemedView>
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          This framework supports iOS, Android, and Web with RevenueCat's web billing.
        </ThemedText>
        {Platform.OS === 'web' && (
          <ThemedText style={styles.webNote}>
            💡 Web billing requires Stripe configuration in your RevenueCat dashboard.
          </ThemedText>
        )}
      </ThemedView>
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          ...
          to move this example code to <ThemedText type="defaultSemiBold">app-example</ThemedText>{' '}
          and create a clean starting point.
        </ThemedText>
      </ThemedView>
    </ParallaxScrollView>
  );
